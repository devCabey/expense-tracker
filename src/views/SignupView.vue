    ...
    <div class="mt-10">
          ...
          <div>
            ...
            <div class="mt-2">
              <input
                ...
                type="email"
                autocomplete="email"
                class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 outline-none ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
      ...
      <div class="mt-10">
        ...
        <div class="mt-6 grid grid-cols-2 gap-4">
          <a
            href="#"
            class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 outline-none ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
          >
